...
poly_dir <- "C:/Users/jlinsky/Documents/MagnoliaCoordinator/Data/SpeciesData/polygons"
  ## PA directory
pa_dir <- "C:/Users/Jean Linsky/Documents/Magnolia_Coordinator/GIS/Protected Areas Maps/Mexico_PAs"
	## for outputs
...
state_bound <- readOGR(file.path(poly_dir,"gadm36_MEX_shp/gadm36_MEX_1.shp"))
