...
pts_dir <- "C:/Users/abyrne/Documents/R/R_practice/R_practice/GCC_R_Training/points"
## for polygon data (ecoregions, states, countries)
poly_dir <- "C:/Users/abyrne/Documents/R/R_practice/R_practice/GCC_R_Training/polygons"
## for outputs
output_dir <- "C:/Users/abyrne/Documents/R/R_practice/R_practice/GCC_R_Training/outputs"
...
exsitu <- read.csv(file.path(pts_dir,paste0(target_sp[sp],
                                            "_exsitu.csv")),na.strings=c("","NA"),stringsAsFactors = F)
str(exsitu)
...
insitu_buff_wgs <- create.buffers(insitu,50000,wgs.proj,wgs.proj,boundary.wgs)
exsitu_buff_wgs <- create.buffers(exsitu,50000,wgs.proj,wgs.proj,boundary.wgs)
...
htmlwidgets::saveWidget(map, file.path(output_dir,paste0(target_sp[sp],"_QSadleriana_leaflet_map.html")))
