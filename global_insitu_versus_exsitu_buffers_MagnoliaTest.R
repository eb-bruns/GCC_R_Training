...
#pts_dir <- "/Volumes/GoogleDrive/My Drive/Conservation Consortia/R Training/occurrence_points/outputs/spp_edited_points"
#pts_dir <- "/Volumes/GoogleDrive/My Drive/Conservation Consortia/R Training/buffer_mapping/points"
pts_dir <- "/Users/emily/Downloads/Magnolia_points"
...
target_sp <- c("Magnolia_tamaulipana","Magnolia_pacifica","Magnolia_mexicana",
	"Magnolia_oaxacensis")
...
# TARGET SPECIES LIST
#		can create by getting names of all files in target folder
#target_sp <- gsub("\\.csv","",list.files(path=pts_dir,pattern=".csv",full.names=F))
#		or can create manually
target_sp <- c("Magnolia_tamaulipana","Magnolia_pacifica","Magnolia_mexicana",
	"Magnolia_oaxacensis")
